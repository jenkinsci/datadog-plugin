...
* [Added] Create spans for webhooks as well. See [#317](https://github.com/jenkinsci/datadog-plugin/pull/317).
* [Added] Webhooks: Do not drop partial git info. See [#319](https://github.com/jenkinsci/datadog-plugin/pull/319).
